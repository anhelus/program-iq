  ...
  return (
    <Timeline align="alternate">
      <Item
        year="2021 - oggi"
        title="Ricercatore"
        description="Dopo un po' di anni, sono tornato lì dove tutto è partito, assumendo il ruolo di Ricercatore presso lo STIIMA del CNR."
        type="work" />
      <Item 
        year="2019 - 2021"
        title="Sviluppatore Mobile"
        description="Nell'ottobre del 2019, sono tornato ad occuparmi di sviluppo in ambito mobile, questa volta per AutoLogS, spin-off del Politecnico di Bari."
        type="work" />
      <Item 
        year="2019"
