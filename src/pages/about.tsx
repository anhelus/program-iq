    ...
    <Layout>
      ...
      <div style={{textAlign: "center", padding:"5vh 0", lineHeight: "1.5", fontSize: 18}}>
        ...
        <div style={{textAlign: "justify"}}>
          <Avatar>IO</Avatar>
          <p><b>RetroPedia</b> vuole essere una sorta di raccolta, o per meglio dire <b>contenitore</b>, rigorosamente amatoriale ed aperiodico, di documenti, storie, ritagli e momenti del mio (e, se state leggendo, immagino <i>nostro</i>) "hobby" preferito, ovvero i videogiochi.</p>
          <p>Ho scritto *"hobby"* tra virgolette perché è evidente come, nel tempo, il videoludo si sia evoluto, passando dai primi, semplici giochi degli anni '70, a forme via via sempre più "consapevoli" e sperimentali, arrivando al giorno d'oggi ad avere pari dignità rispetto a media sicuramente più affermati come, ad esempio, il cinema.</p>
          <p>Cosa dire, quindi, se non <b>benvenuti e...buon viaggio</b>.</p>
        </div>
      </div>
    </Layout>
  )
